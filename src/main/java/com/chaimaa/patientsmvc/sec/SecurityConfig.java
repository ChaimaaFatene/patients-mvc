package com.chaimaa.patientsmvc.sec;

import com.chaimaa.patientsmvc.sec.service.UsersServiceDetailsImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private UsersServiceDetailsImpl usersServiceDetails;
    @Autowired
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
         ...
         */
        auth.userDetailsService(usersServiceDetails);
